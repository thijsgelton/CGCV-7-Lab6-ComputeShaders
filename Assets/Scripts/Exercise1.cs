...
public class Exercise1 : MonoBehaviour
{
    ...
    [SerializeField] private RenderTexture renderTexture, texture;
    ...
    private void Start()
    {
        ...
        computeShader.SetTexture(kernelIndex, "_MandelbrotSet", texture);
        computeShader.SetTexture(kernelIndex, "_ColorGradient", colorGradient);
